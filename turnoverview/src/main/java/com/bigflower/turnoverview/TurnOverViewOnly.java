...
/**
 * Created by Bigflower on 2015/12/7.
 *
 *
 */
public class TurnOverViewOnly extends FrameLayout implements View.OnClickListener {

    private OnTurnOverListener mInterface;
    ...
    public TurnOverViewOnly(Context context) {
        super(context);
    }

    public TurnOverViewOnly(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TurnOverViewOnly(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean isPos(){
        return animateState < ANIM_STATE_POS1 ;
    }
    ...
    public interface OnTurnOverListener {
        void OnClick(TurnOverViewOnly viewTOV) ;
    }
}
